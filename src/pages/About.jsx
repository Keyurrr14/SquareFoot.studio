    ...
    <>
      <div className="min-h-screen bg-beige">
        <div className="w-full flex flex-col items-center justify-center px-4 py-16 md:py-24">
          <motion.h1 {...fadeInUp} className="font-marbley text-brown text-center text-3xl md:text-4xl lg:text-5xl xl:text-6xl max-w-4xl">
            Crafting Exceptional Spaces with Passion and Precision
          </motion.h1>
          <motion.h1 {...fadeInUp} className="font-manrope text-light-brown relative z-10 text-base xs:text-sm sm:text-lg md:text-xl w-[95%] xs:w-[90%] sm:w-[70%] md:w-[50%] lg:w-[50%] text-center mt-4 xs:mt-6 sm:mt-8 md:mt-10 px-2 xs:px-4">
          ...
          <div className="w-full min-h-screen px-4 grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8">
            ...
            <div className="flex flex-col items-start md:items-end justify-between mt-6 md:mt-10 lg:mt-12">
              <div className="flex flex-col items-start md:items-end justify-between w-full">
                ...
                />
                <motion.p {...fadeInUp} className="font-marbley text-brown text-2xl sm:text-3xl md:text-5xl mt-4 sm:mt-6 md:mt-8 w-full sm:w-[85%] md:w-3/4 text-left md:text-left leading-relaxed">
                  Why Choose Us?
                </motion.p>
                <motion.ul {...fadeInUp} className="font-manrope list-disc text-brown text-sm sm:text-md md:text-lg sm:mt-2 md:mt-4 w-full sm:w-[85%] md:w-3/4 text-left md:text-left leading-relaxed">
                  <li>
          ...
          <div className="w-[90%] sm:w-[80%] md:w-[70%] min-h-[300px] sm:min-h-[400px] md:min-h-[500px] flex flex-col items-center justify-center mt-6 sm:mt-8 md:mt-14 mx-auto">
            ...
            />
            <motion.p {...fadeInUp} className="w-[90%] sm:w-[70%] md:w-3/4 lg:w-3/5 font-manrope text-brown text-center text-sm sm:text-lg md:text-xl mt-4 sm:mt-6 md:mt-8">
            ...
            <motion.h1 {...fadeInUp} className="font-southam text-brown -rotate-12 text-4xl sm:text-5xl md:text-6xl lg:text-6xl xl:text-7xl mt-4 sm:mt-6 md:mt-8">
              Faizal Azam
            </motion.h1>
          </div>
        </div>
